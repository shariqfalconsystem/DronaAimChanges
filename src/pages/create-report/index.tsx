import { Box, Button, CircularProgress, Container, Grid, IconButton, TextField, Typography } from '@mui/material';
...
import { getCustomReportToken } from '../../services/fleetManager/reportService';
...
const ReportComponent: React.FC = () => {
  ...
  // Constants
  const datasetId = environment.fmDatasetId;
  ...
  const handleSaveAs = async (): Promise<void> => {
    ...
    try {
      const reportNameWithUserId = userId ? `${reportName}_FM_${userId}` : reportName;
