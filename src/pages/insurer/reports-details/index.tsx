...
import { Box, Button, Container, Grid, IconButton, Tooltip, CircularProgress } from '@mui/material';
import './powerbidemo.css';
import { toast } from 'react-toastify';
import { IoArrowBack } from 'react-icons/io5';
import { RiRefreshLine, RiFileDownloadLine } from '@remixicon/react';
import LoadingScreen from '../../../components/molecules/loading-screen';
import { useSelector } from 'react-redux';
import { exportPowerBIReportToPdf, getReportToken, getReportTokenV3 } from '../../../services/insurer/IReportsService';
...
const ReportDetails = ({ reportId, report, onBack, groupId, isCustomReport }: any) => {
  ...
  }, [userId, currentUserRole, insurerId, lonestarId, groupId, reportId]);
    ...
    if (report.exportReports && report.exportReports.length > 0) {
      ...
      try {
        ...
        for (let i = 0; i < report.exportReports.length; i++) {
          ...
          // Get the PDF blob - pass isPaginated flag and additional parameters to the export function
