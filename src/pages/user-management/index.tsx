            ...
            <Card sx={{ borderRadius: '10px' }}>
              <CardContent sx={{ padding: '0px', fontSize: '0.875rem' }}>
                <SegmentControlDesktop
                  ...
                  columns={[
                    { label: 'User ID', key: 'userId', hideable: false, minWidth: '120px' },
                    { label: 'User Name', key: 'firstAndLastName', hideable: true, minWidth: '150px' },
                    { label: 'Last Login', key: 'lastLoginAtDisplay', hideable: true, minWidth: '180px' },
                    { label: 'Email', key: 'emailId', hideable: true, minWidth: '200px' },
                    { label: 'Phone', key: 'phone', hideable: true, minWidth: '130px' },
                    { label: 'Organization', key: 'organization', hideable: true, minWidth: '150px' },
                    { label: 'Role', key: 'role', hideable: true, minWidth: '120px' },
                    { label: 'Status', key: 'activeStatus', hideable: true, minWidth: '100px' },
                    { label: 'Actions', key: 'actions', hideable: false, minWidth: '100px' },
                  ]}
                />
