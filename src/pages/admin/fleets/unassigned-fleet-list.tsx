...
const UnassignedFleetListTable: React.FC<any> = ({
  ...
  const columns = [
    ...
    ...(shouldShowActions ? [{ label: 'Action', key: 'actions', minWidth: '120px', hideable: false }] : []),
  ];
                      ...
                      {columns
                        ...
                        .map(({ key, minWidth }, index) => {
                          ...
                          if (key === 'primaryContactFullName') {
                            return <StyledDataCell {...commonProps}>{fleet?.primaryContactFullName || 'NA'}</StyledDataCell>;
                          }
