...
const DriversListTable: React.FC<any> = ({
  ...
  const columns = [
    ...
    { label: 'Driver ID', key: 'userId', minWidth: '100px', hideable: false },
    { label: 'Driver Name', key: 'driverName', minWidth: '140px', hideable: true },
    { label: 'Driver Score', key: 'meanScore', minWidth: '110px', hideable: true },
    { label: 'Phone', key: 'phone', minWidth: '120px', hideable: true },
    { label: 'Email', key: 'emailId', minWidth: '180px', hideable: true },
    { label: 'VIN', key: 'vin', minWidth: '140px', hideable: true },
    { label: 'Events Count', key: 'incidentCount', minWidth: '110px', hideable: true },
    { label: 'Actions', key: 'actions', minWidth: '110px', hideable: false },
  ];
